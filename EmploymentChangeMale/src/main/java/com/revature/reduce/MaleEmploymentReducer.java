...
public class MaleEmploymentReducer extends Reducer<Text, OldCurrentPercentagesWritable, Text, Text> {
	/**
	 * The reducer's job is to take in the country name, the year 2000 percentage of male employment, and the latest year percentage of male employment,
